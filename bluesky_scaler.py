...
def process_images_for_bluesky(input_dir, output_dir):
    """
    Process images for Bluesky's maximum dimensions (2000x2000).
    
    Args:
        input_dir (str): Path to the input directory containing images.
        output_dir (str): Path to the output directory for scaled images.
    """
    print(f"Processing images for Bluesky in '{input_dir}'...")
    print(f"Output will be saved to '{output_dir}'.")

    max_dimension = 2000  # Maximum dimension for Bluesky images
